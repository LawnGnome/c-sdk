...
/*
 * The spec for this, including pseudocode, is at
                  ...
                  const char *referring_path_hash)
{
  ...
  /*
   * We then rotate the referring path hash per the Ruby example.
   */
...
uint32_t
nr_hash_md5_low32 (const unsigned char md5[16])
{
  uint32_t result;
...
uint32_t
nr_mkhash (const char *str, int *len)
{
  /*
