 ...
 */
static inline int
nr_php_add_assoc_zval (zval *arr, const char *key, zval *value)
{
#ifdef PHP7
  zval copy;
 ...
 */
static inline int
nr_php_add_index_zval (zval *arr, ulong index, zval *value)
{
#ifdef PHP7
  zval copy;
...
typedef int (*nr_php_ptr_apply_t) (void *value, void *arg,
...
typedef int (*nr_php_zval_apply_t) (zval *value, void *arg,
                                    zend_hash_key *hash_key TSRMLS_DC);
