...
/*
 * Port fallback logic: https://github.com/php/php-src/blob/PHP-5.6/ext/mysql/php_mysql.c#L752-L761
 */
char *
nr_php_mysql_default_port ()
{
...
void
nr_php_mysql_get_host_and_port_path_or_id (const char *host_and_port,
                                           char **host_ptr,
...
nr_php_mysql_create_datastore_instance (const char *host_and_port)
{
...
void
nr_php_mysql_save_datastore_instance (const zval *mysql_conn, const char *host_and_port TSRMLS_DC)
{
  nr_datastore_instance_t *instance;
...
nr_datastore_instance_t *
nr_php_mysql_retrieve_datastore_instance (const zval *mysql_conn TSRMLS_DC)
{
  nr_datastore_instance_t *instance;
  char *key = NULL;
...
void
nr_php_mysql_remove_datastore_instance (const zval *mysql_conn TSRMLS_DC)
{
  char *key = NULL;
