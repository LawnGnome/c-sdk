...
extern nr_framework_classification_t nr_cakephp_special_1 (const zend_op_array *op_array TSRMLS_DC);
extern nr_framework_classification_t nr_cakephp_special_2 (const zend_op_array *op_array TSRMLS_DC);

extern void nr_codeigniter_enable (TSRMLS_D);

extern int nr_drupal_do_view_execute (const char *name, int name_len, NR_EXECUTE_PROTO TSRMLS_DC);
