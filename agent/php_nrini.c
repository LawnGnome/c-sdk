 ...
 * (stage == ZEND_INI_STAGE_STARTUP) (TODO: The reassignment seems
 * broken/backwards, but that's what is discernable from gdb; this 2nd
 * assignment doesn't seem to stem from deactivation.)
 *
 ...
 * values void *mh_arg2                          the blob of data holding all
 * ini values void *mh_arg3          unused for our purposes int stage
 * taken from the set shown below TSRMLS_DC
 *
 ...
 * values void *mh_arg2                          the blob of data holding all
 * ini values void *mh_arg3          unused for our purposes int stage
 * taken from the set shown below
 *
