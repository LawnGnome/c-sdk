 ...
 */
struct _nr_aoffset_t { uint32_t offset; };
typedef struct _nr_aoffset_t nr_aoffset_t;
 ...
 */
extern void nr_flatbuffers_prep (nr_flatbuffer_t *fb, size_t size, size_t additional_bytes);
 ...
 */
extern uint32_t nr_flatbuffers_prepend_string (nr_flatbuffer_t *fb, const char *s);
 ...
 */
extern uint32_t nr_flatbuffers_prepend_bytes (nr_flatbuffer_t *fb, const void *src, uint32_t len);
 ...
 */
extern void nr_flatbuffers_vector_begin (nr_flatbuffer_t *fb, size_t elem_size, size_t num_elems, size_t alignment);
 ...
 *           from another object. (See nr_flatbuffers_object_prepend_uoffset)
 */
extern uint32_t nr_flatbuffers_vector_end (nr_flatbuffer_t *fb, size_t num_elems);
 ...
 */
extern nr_status_t nr_flatbuffers_object_begin (nr_flatbuffer_t *fb, int num_fields);
 ...
 */
extern void nr_flatbuffers_object_prepend_i8      (nr_flatbuffer_t *fb, size_t i, int8_t   x, int8_t   d);
extern void nr_flatbuffers_object_prepend_i16     (nr_flatbuffer_t *fb, size_t i, int16_t  x, int16_t  d);
extern void nr_flatbuffers_object_prepend_i32     (nr_flatbuffer_t *fb, size_t i, int32_t  x, int32_t  d);
extern void nr_flatbuffers_object_prepend_i64     (nr_flatbuffer_t *fb, size_t i, int64_t  x, int64_t  d);
extern void nr_flatbuffers_object_prepend_u8      (nr_flatbuffer_t *fb, size_t i, uint8_t  x, uint8_t  d);
extern void nr_flatbuffers_object_prepend_u16     (nr_flatbuffer_t *fb, size_t i, uint16_t x, uint16_t d);
extern void nr_flatbuffers_object_prepend_u32     (nr_flatbuffer_t *fb, size_t i, uint32_t x, uint32_t d);
extern void nr_flatbuffers_object_prepend_u64     (nr_flatbuffer_t *fb, size_t i, uint64_t x, uint64_t d);
extern void nr_flatbuffers_object_prepend_f32     (nr_flatbuffer_t *fb, size_t i, float    x, float    d);
extern void nr_flatbuffers_object_prepend_f64     (nr_flatbuffer_t *fb, size_t i, double   x, double   d);
extern void nr_flatbuffers_object_prepend_bool    (nr_flatbuffer_t *fb, size_t i, int      x, int      d);
extern void nr_flatbuffers_object_prepend_uoffset (nr_flatbuffer_t *fb, size_t i, uint32_t x, uint32_t d);
extern void nr_flatbuffers_object_prepend_struct  (nr_flatbuffer_t *fb, size_t i, uint32_t x, uint32_t d);
...
extern nr_voffset_t nr_flatbuffers_read_voffset (const uint8_t *buf, size_t offset);
 ...
 * Returns : An offset.
 */
extern nr_aoffset_t nr_flatbuffers_read_indirect (const uint8_t *buf, nr_aoffset_t pos);

/*
 * Purpose : Finalizes a buffer by prepending the offset of the root object.
 *
 * Params  : 1. The buffer to finalize.
 ...
 */
extern int8_t   nr_flatbuffers_table_read_i8   (const nr_flatbuffers_table_t *tbl, size_t i, int8_t   d);
extern int16_t  nr_flatbuffers_table_read_i16  (const nr_flatbuffers_table_t *tbl, size_t i, int16_t  d);
extern int32_t  nr_flatbuffers_table_read_i32  (const nr_flatbuffers_table_t *tbl, size_t i, int32_t  d);
extern int64_t  nr_flatbuffers_table_read_i64  (const nr_flatbuffers_table_t *tbl, size_t i, int64_t  d);
extern uint8_t  nr_flatbuffers_table_read_u8   (const nr_flatbuffers_table_t *tbl, size_t i, uint8_t  d);
extern uint16_t nr_flatbuffers_table_read_u16  (const nr_flatbuffers_table_t *tbl, size_t i, uint16_t d);
extern uint32_t nr_flatbuffers_table_read_u32  (const nr_flatbuffers_table_t *tbl, size_t i, uint32_t d);
extern uint64_t nr_flatbuffers_table_read_u64  (const nr_flatbuffers_table_t *tbl, size_t i, uint64_t d);
extern float    nr_flatbuffers_table_read_f32  (const nr_flatbuffers_table_t *tbl, size_t i, float    d);
extern double   nr_flatbuffers_table_read_f64  (const nr_flatbuffers_table_t *tbl, size_t i, double   d);
extern int      nr_flatbuffers_table_read_bool (const nr_flatbuffers_table_t *tbl, size_t i, int      d);
...
/*
 * TODO(msl): Merge the following two functions. The caller always
 *            needs both the length and the position of the first element.
 */
 ...
 */
extern int nr_flatbuffers_table_read_union (nr_flatbuffers_table_t *child, const nr_flatbuffers_table_t *parent, size_t i);
