...
/*
 * Purpose : Create datastore instance metadata for a Postgres connection via the
 *           pgsql extension.
 *
 ...
 */
extern nr_datastore_instance_t *nr_php_pgsql_create_datastore_instance (const char *conn_info);
