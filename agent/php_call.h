...
#define nr_php_call_callable(callable, params...) ({ \
  zval *call_params[] = {params}; \
  size_t num_call_params = sizeof (call_params) / sizeof (zval *); \
  nr_php_call_callable_zval (callable, num_call_params, call_params TSRMLS_CC); \
})
...
#define nr_php_call_fcall_info(fci, fcc, params...) ({ \
  zval *call_params[] = {params}; \
  size_t num_call_params = sizeof (call_params) / sizeof (zval *); \
  nr_php_call_fcall_info_zval (fci, fcc, num_call_params, call_params TSRMLS_CC); \
})
...
/*
 * TODO(aharvey): Consider if this is particularly useful.
 */
extern zval *
