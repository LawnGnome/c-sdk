...
nr_rules_result_t
nr_rules_apply (const nrrules_t *rules NRUNUSED, const char *name NRUNUSED, char **new_name NRUNUSED)
{
  return NR_RULES_RESULT_UNCHANGED;
}

static void
test_reply_get_int (const nrobj_t *reply, const nrobj_t *arr, const nrobj_t *empty)
{
  int rv;
...
static void
test_reply_get_bool (const nrobj_t *reply, const nrobj_t *arr, const nrobj_t *empty)
{
  int rv;
...
static void
test_reply_get_double (const nrobj_t *reply, const nrobj_t *arr, const nrobj_t *empty)
{
  double rv;
