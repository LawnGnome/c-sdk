...
/*
 * Purpose : Scan double precision numbers, following strtod, but only accepting '.' as a decimal point.
 *
 * Params  : 1. The buffer to scan.
 *           2. A reference to a pointer that will be set pointing to the first nonscanned character.
 *
