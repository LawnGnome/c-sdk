...
nr_hashmap_count_buckets (const nr_hashmap_t *hashmap)
{
  return (size_t) (1 << hashmap->log2_num_buckets);
}

nr_hashmap_t *
nr_hashmap_create (nr_hashmap_dtor_func_t dtor_func)
{
  return nr_hashmap_create_internal (0, dtor_func);
}

nr_hashmap_t *
nr_hashmap_create_buckets (size_t buckets, nr_hashmap_dtor_func_t dtor_func)
{
...
void
nr_hashmap_destroy (nr_hashmap_t **hashmap_ptr)
{
  size_t count;
...
void
nr_hashmap_apply (nr_hashmap_t *hashmap, nr_hashmap_apply_func_t apply_func,
                  void *user_data)
{
  size_t count;
  size_t i;
...
size_t
nr_hashmap_count (const nr_hashmap_t *hashmap)
{
  if (NULL == hashmap) {
    return 0;
  }
...
nr_status_t
nr_hashmap_delete (nr_hashmap_t *hashmap, const char *key, size_t key_len)
{
...
void *
nr_hashmap_get (nr_hashmap_t *hashmap, const char *key, size_t key_len)
{
  void *value = NULL;
...
int
nr_hashmap_get_into (nr_hashmap_t *hashmap, const char *key, size_t key_len,
                     void **value_ptr)
{
  nr_hashmap_bucket_t *bucket = NULL;
  size_t hash;
...
int
nr_hashmap_has (nr_hashmap_t *hashmap, const char *key, size_t key_len)
{
  size_t hash;
...
nr_status_t
nr_hashmap_set (nr_hashmap_t *hashmap, const char *key, size_t key_len,
                void *value)
{
  size_t hash;
...
void
nr_hashmap_update (nr_hashmap_t *hashmap, const char *key, size_t key_len,
                   void *value)
{
  nr_hashmap_bucket_t *bucket = NULL;
  size_t hash;
...
void
nr_hashmap_add_internal (nr_hashmap_t *hashmap, size_t hash_key,
...
nr_hashmap_t *
nr_hashmap_create_internal (size_t log2_num_buckets,
                            nr_hashmap_dtor_func_t dtor_func)
{
  ...
  hashmap->buckets = (nr_hashmap_bucket_t **) nr_calloc ((1 << log2_num_buckets),
                                                         sizeof (nr_hashmap_bucket_t *));
  hashmap->elements = 0;
...
void
nr_hashmap_destroy_bucket (nr_hashmap_bucket_t **bucket_ptr,
                           nr_hashmap_dtor_func_t dtor_func)
{
...
int
nr_hashmap_fetch (nr_hashmap_t *hashmap, size_t hash_key,
...
size_t
nr_hashmap_hash_key (size_t log2_num_buckets, const char *key, size_t key_len)
{
  int len = (int) key_len;
