...
typedef struct {
  ...
  /*
   * These strings must conform to the spec to ensure agent consistency.
...
static size_t datastore_mappings_len = sizeof (datastore_mappings) /
                                       sizeof (nr_datastore_mapping_t);
