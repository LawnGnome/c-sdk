...
static void
test_output_flags (void)
{
#if ZEND_MODULE_API_NO >= ZEND_5_4_X_API_NO
  test_output_flag_func ("has content", nr_php_output_has_content, 1, PHP_OUTPUT_HANDLER_WRITE);
  test_output_flag_func ("has content", nr_php_output_has_content, 1, PHP_OUTPUT_HANDLER_START);
  test_output_flag_func ("has content", nr_php_output_has_content, 0, PHP_OUTPUT_HANDLER_CLEAN);
  test_output_flag_func ("has content", nr_php_output_has_content, 1, PHP_OUTPUT_HANDLER_FLUSH);
  test_output_flag_func ("has content", nr_php_output_has_content, 1, PHP_OUTPUT_HANDLER_FINAL);
  test_output_flag_func ("has content", nr_php_output_has_content, 0, INT_MAX);

  test_output_flag_func ("is end", nr_php_output_is_end, 0, PHP_OUTPUT_HANDLER_WRITE);
  test_output_flag_func ("is end", nr_php_output_is_end, 0, PHP_OUTPUT_HANDLER_START);
  test_output_flag_func ("is end", nr_php_output_is_end, 0, PHP_OUTPUT_HANDLER_CLEAN);
  test_output_flag_func ("is end", nr_php_output_is_end, 0, PHP_OUTPUT_HANDLER_FLUSH);
  test_output_flag_func ("is end", nr_php_output_is_end, 1, PHP_OUTPUT_HANDLER_FINAL);
  test_output_flag_func ("is end", nr_php_output_is_end, 1, INT_MAX);

  test_output_flag_func ("is start", nr_php_output_is_start, 0, PHP_OUTPUT_HANDLER_WRITE);
  test_output_flag_func ("is start", nr_php_output_is_start, 1, PHP_OUTPUT_HANDLER_START);
  test_output_flag_func ("is start", nr_php_output_is_start, 0, PHP_OUTPUT_HANDLER_CLEAN);
  test_output_flag_func ("is start", nr_php_output_is_start, 0, PHP_OUTPUT_HANDLER_FLUSH);
  test_output_flag_func ("is start", nr_php_output_is_start, 0, PHP_OUTPUT_HANDLER_FINAL);
  test_output_flag_func ("is start", nr_php_output_is_start, 1, INT_MAX);
#else /* PHP < 5.4 */
  test_output_flag_func ("has content", nr_php_output_has_content, 1, PHP_OUTPUT_HANDLER_START);
  test_output_flag_func ("has content", nr_php_output_has_content, 1, PHP_OUTPUT_HANDLER_CONT);
  test_output_flag_func ("has content", nr_php_output_has_content, 1, PHP_OUTPUT_HANDLER_END);
  test_output_flag_func ("has content", nr_php_output_has_content, 1, INT_MAX);

  test_output_flag_func ("is end", nr_php_output_is_end, 0, PHP_OUTPUT_HANDLER_START);
  test_output_flag_func ("is end", nr_php_output_is_end, 0, PHP_OUTPUT_HANDLER_CONT);
  test_output_flag_func ("is end", nr_php_output_is_end, 1, PHP_OUTPUT_HANDLER_END);
  test_output_flag_func ("is end", nr_php_output_is_end, 1, INT_MAX);

  test_output_flag_func ("is start", nr_php_output_is_start, 1, PHP_OUTPUT_HANDLER_START);
  test_output_flag_func ("is start", nr_php_output_is_start, 0, PHP_OUTPUT_HANDLER_CONT);
  test_output_flag_func ("is start", nr_php_output_is_start, 0, PHP_OUTPUT_HANDLER_END);
  test_output_flag_func ("is start", nr_php_output_is_start, 1, INT_MAX);
#endif /* PHP >= 5.4 */
}
 ...
 */
static void
output_handler (char *output NRUNUSED,
 ...
 */
static void
test_output_handler_count_f (const char *message, size_t expected,
...
/*
 * Implementation function and wrapper macros for tests that asserts that a
 * particular named output handler is either active or inactive.
 */
static void
test_output_handler_f (const char *message, const char *name, int expected,
                       const char *file, int line TSRMLS_DC)
{
  zval *handler = NULL;
  zval *handlers;
  ...
  ZEND_HASH_FOREACH_VAL (Z_ARRVAL_P (handlers), handler) {
    if (0 == nr_php_is_zval_valid_string (handler)) {
      tlib_pass_if_true_f (message, 0, file, line, "invalid handler",
                          "type=%d", (int) Z_TYPE_P (handler));
      goto end;
    }

    if (0 == nr_strncmp (name, Z_STRVAL_P (handler),
...
static void
test_output_install_handler (TSRMLS_D)
{
