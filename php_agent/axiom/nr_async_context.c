...
nr_async_context_t* nr_async_context_create(nrtime_t start) {
...
void nr_async_context_destroy(nr_async_context_t** context_ptr) {
  nr_realfree((void**)context_ptr);
}

void nr_async_context_add(nr_async_context_t* context, nrtime_t duration) {
  if (NULL == context) {
    return;
  }
...
void nr_async_context_end(nr_async_context_t* context, nrtime_t stop) {
  if (NULL == context) {
    return;
  }
...
nrtime_t nr_async_context_get_duration(const nr_async_context_t* context) {
  nrtime_t wallclock;
