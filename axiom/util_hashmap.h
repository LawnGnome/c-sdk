 ...
 *
 * Params  : 1. A pointer to the hashmap to destroy.
 */
extern void
 ...
 */
static inline nr_status_t
nr_hashmap_index_delete (nr_hashmap_t *hashmap, uint64_t index)
{
  return nr_hashmap_delete (hashmap, (const char *) &index, sizeof (uint64_t));
}

static inline void *
nr_hashmap_index_get (nr_hashmap_t *hashmap, uint64_t index)
{
  return nr_hashmap_get (hashmap, (const char *) &index, sizeof (uint64_t));
}

static inline int
nr_hashmap_index_set (nr_hashmap_t *hashmap, uint64_t index, void *value)
{
  return nr_hashmap_set (hashmap, (const char *) &index, sizeof (uint64_t),
                         value);
}

static inline void
nr_hashmap_index_update (nr_hashmap_t *hashmap, uint64_t index, void *value)
{
