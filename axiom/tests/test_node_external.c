...
static nr_node_external_params_t
mock_external_params_url (nrtime_t duration, char *url)
{
...
static nr_node_external_params_t
mock_external_params (nrtime_t duration)
{
...
test_domain_parsing_fails (void)
{
  ...
  nrtxn_t *txn = new_txn (0);
  nrtime_t duration = 4 * NR_TIME_DIVISOR;
  nr_node_external_params_t params = mock_external_params_url (duration, "@@@@@");
...
test_junk_url (void)
{
  ...
  nrtxn_t *txn = new_txn (0);
  nrtime_t duration = 4 * NR_TIME_DIVISOR;
  nr_node_external_params_t params = mock_external_params_url (duration, "this is a junk url");
...
test_url_saving_strips_parameters (void)
{
  ...
  nrtxn_t *txn = new_txn (0);
  nrtime_t duration = 4 * NR_TIME_DIVISOR;
  nr_node_external_params_t params = mock_external_params_url (duration, "http://newrelic.com?secret=shhhhhh");
...
test_external_id_and_txnname (void)
{
  ...
  params.encoded_response_header = "{\"id\":\"12345#6789\",\"txnname\":\"my_txn\"}";
...
test_external_id_txnname_and_guid (void)
{
  ...
  params.encoded_response_header = "{\"id\":\"12345#6789\",\"txnname\":\"my_txn\",\"guid\":\"0123456789ABCDEF\"}";
