...
/*
 * TODO(msl): Should there be an option to force a traced error?
 */
 ...
 */
typedef nr_php_exception_action_t (*nr_php_exception_filter_fn) (zval *exception TSRMLS_DC);
 ...
 * Returns : One of the nr_php_exception_action_t values.
 */
extern nr_php_exception_action_t
 ...
 *              Typically, &NRPRG (exception_filters) or NULL to disable exception filtering.
 *
