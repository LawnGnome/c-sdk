...
struct _nr_voffset_t { uint16_t offset; };
...
nr_flatbuffer_t *
nr_flatbuffers_create (size_t initial_size)
{
  nr_flatbuffer_t *fb;
...
const uint8_t *
nr_flatbuffers_data (const nr_flatbuffer_t *fb)
{
  if (fb) {
    return fb->pos;
  }
...
size_t
nr_flatbuffers_len (const nr_flatbuffer_t *fb)
{
  if (fb) {
...
void
nr_flatbuffers_destroy (nr_flatbuffer_t **fb_ptr)
{
  nr_flatbuffer_t *fb;
...
int8_t
nr_flatbuffers_read_i8 (const uint8_t *buf, size_t offset)
{
  return (int8_t)buf[offset];
}

int16_t
nr_flatbuffers_read_i16 (const uint8_t *buf, size_t offset)
{
  int16_t x = 0;
...
int32_t
nr_flatbuffers_read_i32 (const uint8_t *buf, size_t offset)
{
  int32_t x = 0;
...
int64_t
nr_flatbuffers_read_i64 (const uint8_t *buf, size_t offset)
{
  int64_t x = 0;
...
uint8_t
nr_flatbuffers_read_u8 (const uint8_t *buf, size_t offset)
{
  return buf[offset];
}

uint16_t
nr_flatbuffers_read_u16 (const uint8_t *buf, size_t offset)
{
  uint16_t x = 0;
...
uint32_t
nr_flatbuffers_read_u32 (const uint8_t *buf, size_t offset)
{
  uint32_t x = 0;
...
uint64_t
nr_flatbuffers_read_u64 (const uint8_t *buf, size_t offset)
{
  uint64_t x = 0;
...
float
nr_flatbuffers_read_f32 (const uint8_t *buf, size_t offset)
{
  uint32_t x;
  float y;
...
double
nr_flatbuffers_read_f64 (const uint8_t *buf, size_t offset)
{
  uint64_t x;
  double y;
...
int32_t
nr_flatbuffers_read_soffset (const uint8_t *buf, size_t offset)
{
  int32_t x = 0;
...
uint32_t
nr_flatbuffers_read_uoffset (const uint8_t *buf, size_t offset)
{
  uint32_t x = 0;
...
nr_voffset_t
nr_flatbuffers_read_voffset (const uint8_t *buf, size_t offset)
{
...
nr_aoffset_t
nr_flatbuffers_read_indirect (const uint8_t *buf, nr_aoffset_t pos)
{
...
void
nr_flatbuffers_pad (nr_flatbuffer_t *fb, size_t n)
{
  fb->pos -= n;
...
static void
nr_flatbuffers_grow (nr_flatbuffer_t *fb)
{
  size_t used;
  size_t old_size;
  size_t new_size;
...
void
nr_flatbuffers_prep (nr_flatbuffer_t *fb, size_t size, size_t additional_bytes)
{
  size_t pad_size;
...
static void
nr_flatbuffers_put_u8 (nr_flatbuffer_t *fb, uint8_t x)
{
...
static void
nr_flatbuffers_put_u16 (nr_flatbuffer_t *fb, uint16_t x)
{
...
static void
nr_flatbuffers_put_u32 (nr_flatbuffer_t *fb, uint32_t x)
{
...
static void
nr_flatbuffers_put_u64 (nr_flatbuffer_t *fb, uint64_t x)
{
...
static void
nr_flatbuffers_put_i8 (nr_flatbuffer_t *fb, int8_t x)
{
...
static void
nr_flatbuffers_put_i16 (nr_flatbuffer_t *fb, int16_t x)
{
...
static void
nr_flatbuffers_encode_i32 (uint8_t *p, int32_t x)
{
  p[0] = (uint8_t)x;
  p[1] = (uint8_t)(x >> 8);
  p[2] = (uint8_t)(x >> 16);
...
static void
nr_flatbuffers_put_i32 (nr_flatbuffer_t *fb, int32_t x)
{
...
static void
nr_flatbuffers_put_i64 (nr_flatbuffer_t *fb, int64_t x)
{
...
static void
nr_flatbuffers_put_f32 (nr_flatbuffer_t *fb, float x)
{
  uint32_t n;
...
static void
nr_flatbuffers_put_f64 (nr_flatbuffer_t *fb, double x)
{
  uint64_t n;
...
#define NR_FLATBUFFERS_PREPEND(TYPE, SUFFIX)                            \
  void                                                                  \
  nr_flatbuffers_prepend_ ## SUFFIX (nr_flatbuffer_t *fb, TYPE x)       \
  {                                                                     \
...
void
nr_flatbuffers_prepend_bool (nr_flatbuffer_t *fb, int x)
{
...
void
nr_flatbuffers_prepend_uoffset (nr_flatbuffer_t *fb, uint32_t offset)
{
  uint32_t relative_offset;

  nr_flatbuffers_prep (fb, sizeof (uint32_t), 0); /* ensure proper alignment */
  nr_flatbuffers_assert (offset <= nr_flatbuffers_len (fb)); /* ensure offset is reachable */
...
uint32_t
nr_flatbuffers_prepend_string (nr_flatbuffer_t *fb, const char *s)
{
  size_t len;
...
uint32_t
nr_flatbuffers_prepend_bytes (nr_flatbuffer_t *fb, const void *src, uint32_t len)
{
...
nr_status_t
nr_flatbuffers_object_begin (nr_flatbuffer_t *fb, int num_fields)
{
  if (NULL == fb) {
    return NR_FAILURE;
  }
  ...
  if (fb->vtable_cap < num_fields) {
    fb->vtable = (uint32_t *)nr_realloc (fb->vtable, num_fields * sizeof (uint32_t));
...
#define NR_FLATBUFFERS_OBJECT_PREPEND(TYPE, SUFFIX) \
  void                                                                  \
  nr_flatbuffers_object_prepend_ ## SUFFIX (nr_flatbuffer_t *fb, size_t i, TYPE x, TYPE d) \
  {                                                                     \
    if (x != d) {                                                       \
...
void
nr_flatbuffers_object_prepend_bool (nr_flatbuffer_t *fb, size_t i, int x, int d)
{
  /* Normalize to 0 or 1. */
  x = x ? 1 : 0;
  d = d ? 1 : 0;
...
void
nr_flatbuffers_object_prepend_struct (nr_flatbuffer_t *fb, size_t i, uint32_t x, uint32_t d)
{
  if (x != d) {
    fb->vtable[i] = (uint32_t)nr_flatbuffers_len (fb);
  }
...
static void
nr_flatbuffers_save_vtable (nr_flatbuffer_t *fb, uint32_t vtable_offset)
{
  if (fb->vtables_len == fb->vtables_cap) {
    int new_capacity = fb->vtables_cap * 2;

    fb->vtables = (uint32_t *)nr_realloc (fb->vtables, new_capacity * sizeof (uint32_t));
 ...
 */
static int
nr_flatbuffers_vtable_num_fields (const nr_flatbuffer_t *fb, int i)
{
  if (i < fb->vtables_len) {
    size_t offset;
    size_t size;
...
static uint16_t
nr_flatbuffers_vtable_field (const nr_flatbuffer_t *fb, int i, size_t j)
{
  size_t offset;
...
static int
nr_flatbuffers_match_vtable (const nr_flatbuffer_t *fb, int vtable_idx)
{
  int i;
  int num_fields;
 ...
 */
static uint32_t
nr_flatbuffers_find_existing_vtable (const nr_flatbuffer_t *fb)
{
  int i;
...
/*
 * See comment above WriteVtable in vendor/src/github.com/google/flatbuffers/go/builder.go.
 */
static uint32_t
nr_flatbuffers_prepend_vtable (nr_flatbuffer_t *fb)
{
  int i;
  ...
  if (0 == existing_vtable) {
     ...
     */
    nr_flatbuffers_encode_i32 (fb->back - object_offset,
...
uint32_t
nr_flatbuffers_object_end (nr_flatbuffer_t *fb)
{
  uint32_t offset = 0;
...
void
nr_flatbuffers_vector_begin (nr_flatbuffer_t *fb, size_t elem_size, size_t num_elems, size_t alignment)
{
  size_t size;
...
uint32_t
nr_flatbuffers_vector_end (nr_flatbuffer_t *fb, size_t num_elems)
{
...
void
nr_flatbuffers_finish (nr_flatbuffer_t *fb, uint32_t root_table)
{
...
/*
 * TODO(msl) Verify table is sane.
 *
 *  - Has sufficent space for vsize and osize.
 *  - Has sufficient space for vsize + osize.
 *  - Object's vtable offset == data + offset.
 *  - All vtable offsets are within object data.
 *  - All object field offsets are within [data, data+length).
 */

void
nr_flatbuffers_table_init_root (nr_flatbuffers_table_t *tbl, const uint8_t *data, size_t len)
{
  size_t offset;
...
void
nr_flatbuffers_table_init (nr_flatbuffers_table_t *tbl, const uint8_t *data, size_t len, size_t offset)
{
  tbl->data = data;
  tbl->length = len;
  tbl->offset = offset;
   ...
   */
  tbl->vtable = (size_t)((ptrdiff_t)offset - (ptrdiff_t)nr_flatbuffers_read_soffset (data, offset));
 ...
 */
nr_aoffset_t
nr_flatbuffers_table_lookup (const nr_flatbuffers_table_t *tbl, size_t i)
{
  size_t offset;
  nr_voffset_t field;
...
nr_aoffset_t
nr_flatbuffers_table_read_vector (const nr_flatbuffers_table_t *tbl, size_t i)
{
...
uint32_t
nr_flatbuffers_table_read_vector_len (const nr_flatbuffers_table_t *tbl, size_t i)
{
  nr_aoffset_t absolute;
...
const void *
nr_flatbuffers_table_read_bytes (const nr_flatbuffers_table_t *tbl, size_t i)
{
  nr_aoffset_t absolute;
...
const char *
nr_flatbuffers_table_read_str (const nr_flatbuffers_table_t *tbl, size_t i)
{
  /* TODO(msl): assert trailing zero is present? */
  return (const char *)nr_flatbuffers_table_read_bytes (tbl, i);
}

int
nr_flatbuffers_table_read_union (nr_flatbuffers_table_t *child, const nr_flatbuffers_table_t *parent, size_t i)
{
  nr_aoffset_t absolute;

  absolute = nr_flatbuffers_table_lookup (parent, i);
  if (0 != absolute.offset) {
    absolute.offset += nr_flatbuffers_read_uoffset (parent->data, absolute.offset);
    nr_flatbuffers_table_init (child, parent->data, parent->length, absolute.offset);
    return 1;
  }
  return 0;
}
...
#define FLATBUFFERS_TABLE_READ(TYPE, SUFFIX)                            \
  TYPE                                                                  \
  nr_flatbuffers_table_read_ ## SUFFIX (const nr_flatbuffers_table_t *tbl, size_t i, TYPE d) \
  {                                                                     \
...
int
nr_flatbuffers_table_read_bool (const nr_flatbuffers_table_t *tbl, size_t i, int d)
{
