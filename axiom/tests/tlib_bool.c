...
int
tlib_pass_if_true_f (const char *what, int val, const char *file, int line, const char *cond, const char *fmt, ...)
{
  va_list ap;
...
int
tlib_pass_if_false_f (const char *what, int val, const char *file, int line, const char *cond, const char *fmt, ...)
{
  va_list ap;
...
int
tlib_fail_if_true_f (const char *what, int val, const char *file, int line, const char *cond, const char *fmt, ...)
{
  va_list ap;
...
int
tlib_fail_if_false_f (const char *what, int val, const char *file, int line, const char *cond, const char *fmt, ...)
{
  va_list ap;
