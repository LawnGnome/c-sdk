...
void
nr_explain_plan_destroy (nr_explain_plan_t **plan_ptr)
{
...
int
nr_explain_plan_column_count (const nr_explain_plan_t *plan)
{
  if (NULL == plan) {
    return 0;
  }
...
void
nr_explain_plan_add_column (nr_explain_plan_t *plan, const char *name)
{
...
void
nr_explain_plan_add_row (nr_explain_plan_t *plan, const nrobj_t *row)
{
...
char *
nr_explain_plan_to_json (const nr_explain_plan_t *plan)
{
  char *json = NULL;
  nrobj_t *obj = NULL;
...
nrobj_t *
nr_explain_plan_to_object (const nr_explain_plan_t *plan)
{
  nrobj_t *obj = NULL;
