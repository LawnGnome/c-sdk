 ...
 */
extern int
nr_php_header_handler (sapi_header_struct *sapi_header, sapi_header_op_enum op,
...
/*
 * Purpose : Provide safe access to the response headers for the current request.
 *
...
/*
 * Purpose : Provide safe access to the http response code for the current request.
 *
