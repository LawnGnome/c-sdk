 ...
 * functions.
 *
 * This file follows the same conventions as str_util.h for making nr_foo
 ...
 */
#if defined(__GNUC__)
  #define nr_alloca(X) ({ char *_alloca_p = (char *)alloca(X); _alloca_p[0] = 0; _alloca_p; })
#else
 ...
 */
static inline void *
nr_memset (void *buf, int val, int count)
{
 ...
 */
static inline void *
nr_memcpy (void *dest, const void *src, int len)
{
 ...
 */
static inline void *
nr_memmove (void *dest, const void *src, int len)
{
  if (nrlikely (dest && src && (len > 0))) {
 ...
 */
static inline int
nr_memcmp (const void *s1, const void *s2, int len)
{
 ...
 */
static inline void *
nr_memchr (const void *str, int c, int len)
{
