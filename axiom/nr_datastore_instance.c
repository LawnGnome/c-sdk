...
nr_datastore_instance_create (const char *host, const char *port_path_or_id, const char *database_name)
{
  nr_datastore_instance_t *instance;

  instance = (nr_datastore_instance_t *)nr_zalloc (sizeof (nr_datastore_instance_t));
...
void
nr_datastore_instance_destroy (nr_datastore_instance_t **instance_ptr)
{
...
/*
 * See: https://source.datanerd.us/agents/agent-specs/blob/master/Datastore-Metrics-PORTED.md#datastore-instance-identifier
 */
int
nr_datastore_instance_is_localhost (const char *host)
{
...
const char *
nr_datastore_instance_get_host (nr_datastore_instance_t *instance)
{
  if (NULL == instance) {
    return NULL;
  }
...
const char *
nr_datastore_instance_get_port_path_or_id (nr_datastore_instance_t *instance)
{
  if (NULL == instance) {
    return NULL;
  }
...
const char *
nr_datastore_instance_get_database_name (nr_datastore_instance_t *instance)
{
  if (NULL == instance) {
    return NULL;
  }
...
void
nr_datastore_instance_set_host (nr_datastore_instance_t *instance, const char *host)
{
  if (NULL == instance) {
    return;
  }
...
void
nr_datastore_instance_set_port_path_or_id (nr_datastore_instance_t *instance, const char *port_path_or_id)
{
  if (NULL == instance) {
    return;
  }
...
void
nr_datastore_instance_set_database_name (nr_datastore_instance_t *instance, const char *database_name)
{
  if (NULL == instance) {
    return;
  }
