...
static void test_get_duration(void) {
  nr_async_context_t* context = nr_async_context_create(1);

  /*
   * Test : Bad parameters.
   */
  tlib_pass_if_time_equal("NULL context", 0,
                          nr_async_context_get_duration(NULL));
  tlib_pass_if_time_equal("unstopped context", 0,
                          nr_async_context_get_duration(context));
  ...
  nr_async_context_end(context, 42);
  tlib_pass_if_time_equal("wallclock > async_duration", 0,
                          nr_async_context_get_duration(context));
  ...
  tlib_pass_if_time_equal("wallclock < async_duration", 10,
                          nr_async_context_get_duration(context));
