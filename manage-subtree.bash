...
then
    ...
    echo "CALLING: "
    echo ""   
    echo "       $ ./update-subtree.bash view_commit_hashes"     
    echo "       $ ./update-subtree.bash set_commit_hashes"         
    echo ""           
    echo "       $ ./update-subtree.bash add_subtrees"
    echo "       $ ./update-subtree.bash update_subtrees"    
    echo ""       
    echo "       $ ./update-subtree.bash update_version_yml"                 
fi