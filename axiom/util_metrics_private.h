...
extern nrmetric_t *nrm_find_internal (nrmtable_t *table, const char *name, uint32_t hash);
extern nrmetric_t *nrm_create (nrmtable_t *table, const char *name, uint32_t hash);
