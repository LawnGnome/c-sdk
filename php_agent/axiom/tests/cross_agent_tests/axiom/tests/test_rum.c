  ...
  tlib_pass_if_true(
      ...
      0
          == nr_strcmp(ftr,
                       ...
                       "\"transactionName\":"
                       "\"YwBaN0IACkICVxFfXFpKWhFZDw8eDFJKUV9bF0E=\","
                       "\"queueTime\":3,"
                       "\"applicationTime\":5,"
                       "\"atts\":"
                       "\"T0dNQQoaRkERWwFDUEBHAkFdGDgeE0YKUkZXERpPEgAHUgxBC0IRD"
                       "kdVGmxOBVIAWxBYRxZJGhZDBBYTWRYIT28bEEsGQkMZHUFVRwxIFh9R"
                       "ExJbRksCREdLTg==\","
...
static void test_rum_injection_oddball(void) {
   ...
   * comes back null. This smells like a bug.
   */
