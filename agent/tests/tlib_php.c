...
const char* app_connect_reply
    = "{"
      ...
      "p=\\\"\\\"+location,l={beacon:\\\"bam.nr-data.net\\\",errorBeacon:"
      "\\\"bam.nr-data.net\\\",agent:\\\"js-agent.newrelic.com/"
      ...
      "https://staging.newrelic.com/accounts/204549/applications/18303\""
      "      }"
      "   ],"
