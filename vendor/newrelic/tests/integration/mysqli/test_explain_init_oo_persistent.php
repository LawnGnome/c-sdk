...
/*DESCRIPTION
The agent should generate explain plans when persistent connections are made
with mysqli::init() and mysqli::real_connect().
*/
...
$link->real_connect("p:$MYSQL_HOST", $MYSQL_USER, $MYSQL_PASSWD, $MYSQL_DB, $MYSQL_PORT, $MYSQL_SOCKET);
