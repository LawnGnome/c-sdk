 ...
 * by the new distributed tracing functionality (the create payload function,
 * the accept payload function, any intrinsic setting code, etc.), and
 * serve as the "source of truth" for of any bit of distributed trace
 * metadata that's shared between the distinct parts of distributed tracing.
 *
