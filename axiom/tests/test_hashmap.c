...
static void
apply_func (uint64_t *value, const char *key, size_t key_len, uint64_t *sum)
{
  *sum += *value;
...
test_delete (void)
{
   ...
   * Test : Bad parameters.
   */
  tlib_pass_if_status_failure ("NULL hashmap", nr_hashmap_delete (NULL, "foo", 3));
  tlib_pass_if_status_failure ("NULL key", nr_hashmap_delete (hashmap, NULL, 3));
  tlib_pass_if_status_failure ("empty key", nr_hashmap_delete (hashmap, "foo", 0));

  /*
   * Test : Non-existent key.
   */
  tlib_pass_if_status_failure ("missing key", nr_hashmap_delete (hashmap, NR_PSTR ("foo")));

  /*
   * Test : Extant key.
   */
  nr_hashmap_update (hashmap, NR_PSTR ("foo"), NULL);
  tlib_fail_if_int_equal ("before delete", 0, nr_hashmap_has (hashmap, NR_PSTR ("foo")));
  ...
  tlib_pass_if_int_equal ("after delete", 0, nr_hashmap_has (hashmap, NR_PSTR ("foo")));
...
test_get_set (void)
{
  ...
  tlib_pass_if_status_failure ("NULL hashmap", nr_hashmap_set (NULL, NR_PSTR ("foo"), NULL));
  tlib_pass_if_status_failure ("NULL hashmap", nr_hashmap_set (hashmap, NULL, 1, NULL));
  tlib_pass_if_status_failure ("NULL hashmap", nr_hashmap_set (hashmap, NR_PSTR (""), NULL));
  ...
  tlib_pass_if_status_success ("first set", nr_hashmap_set (hashmap, NR_PSTR ("foo"), value));
  tlib_pass_if_status_failure ("duplicate set", nr_hashmap_set (hashmap, NR_PSTR ("foo"), value));
  tlib_pass_if_status_success ("second set", nr_hashmap_set (hashmap, NR_PSTR ("bar"), NULL));
   ...
   */
  nr_hashmap_update (hashmap, NR_PSTR ("foo"), NULL);
  tlib_pass_if_ptr_equal ("update", NULL, nr_hashmap_get (hashmap, NR_PSTR ("foo")));

  nr_hashmap_update (hashmap, NR_PSTR ("quux"), value);
  tlib_pass_if_ptr_equal ("update", value, nr_hashmap_get (hashmap, NR_PSTR ("quux")));
...
test_get_into (void)
{
   ...
   * Test : Bad parameters.
   */
  tlib_pass_if_int_equal ("NULL hashmap", 0, nr_hashmap_get_into (NULL, NR_PSTR ("foo"), &out));
  tlib_pass_if_ptr_equal ("out is unchanged", &hashmap, out);
  tlib_pass_if_int_equal ("NULL key", 0, nr_hashmap_get_into (hashmap, NULL, 1, &out));
  tlib_pass_if_ptr_equal ("out is unchanged", &hashmap, out);
  tlib_pass_if_int_equal ("empty key", 0, nr_hashmap_get_into (hashmap, NR_PSTR (""), &out));
  tlib_pass_if_ptr_equal ("out is unchanged", &hashmap, out);
  tlib_pass_if_int_equal ("NULL out", 0, nr_hashmap_get_into (hashmap, NR_PSTR ("foo"), NULL));

  /*
   * Test : nr_hashmap_get_into on an empty hashmap.
   */
  tlib_pass_if_int_equal ("empty hashmap", 0, nr_hashmap_get_into (hashmap, NR_PSTR ("foo"), &out));
  tlib_pass_if_ptr_equal ("out is unchanged", &hashmap, out);
   ...
   */
  tlib_pass_if_int_equal ("foo", 1, nr_hashmap_get_into (hashmap, NR_PSTR ("foo"), &out));
  tlib_pass_if_ptr_equal ("foo", value, out);
  tlib_pass_if_int_equal ("bar", 0, nr_hashmap_get_into (hashmap, NR_PSTR ("bar"), &out));
  tlib_pass_if_ptr_equal ("out is unchanged", value, out);
  tlib_pass_if_int_equal ("null", 1, nr_hashmap_get_into (hashmap, NR_PSTR ("null"), &out));
...
test_has (void)
{
   ...
   * Test : Non-existent key.
   */
  tlib_pass_if_int_equal ("missing key", 0, nr_hashmap_has (hashmap, NR_PSTR ("foo")));

  /*
   * Test : Extant key.
   */
  nr_hashmap_update (hashmap, NR_PSTR ("foo"), NULL);
  tlib_fail_if_int_equal ("after update", 0, nr_hashmap_has (hashmap, NR_PSTR ("foo")));
...
test_stress (void)
{
  ...
  tlib_pass_if_size_t_equal ("count", num - (num / 4), nr_hashmap_count (hashmap));
