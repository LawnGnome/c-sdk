 ...
 *
 * The apdex specification: http://apdex.org/documents/ApdexTechnicalSpecificationV11_000.pdf
 */
...
nr_apdex_zone (nrtime_t apdex_threshold, nrtime_t duration);
 ...
 */
extern char
nr_apdex_zone_label (nr_apdex_zone_t apdex);
