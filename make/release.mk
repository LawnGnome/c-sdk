#
# Build recipes for constructing an agent release with NRLAMP.
#
...
#
# TODO(msl): It would be nice to fix this someday, but that will require
# also updating the install script and considering if there are any
...
#
# Add a new target to build the agent against NRLAMP.
#
