...
/*
 * Purpose : Used to prepare a process for common fatal signal handling. This must
 *           be called after the log file has been opened, and is most useful
 *           if called when, for example, the SIGSEGV, SIGBUS, SIGFPE or SIGILL handler is being installed.
 *
 * Params  : None.
 *
 * Returns : Nothing.
 ...
 *           supports that. Will do nothing if nr_signal_tracer_prep () above has
 *           not been called.
 *
