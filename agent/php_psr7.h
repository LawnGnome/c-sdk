 ...
 */
static inline int
nr_php_psr7_is_message (zval *z TSRMLS_DC)
{
  return nr_php_object_instanceof_class (z,
    "Psr\\Http\\Message\\MessageInterface" TSRMLS_CC);
}
 ...
 */
static inline int
nr_php_psr7_is_request (zval *z TSRMLS_DC)
{
  return nr_php_object_instanceof_class (z,
    "Psr\\Http\\Message\\RequestInterface" TSRMLS_CC);
}
 ...
 */
static inline int
nr_php_psr7_is_response (zval *z TSRMLS_DC)
{
  return nr_php_object_instanceof_class (z,
    "Psr\\Http\\Message\\ResponseInterface" TSRMLS_CC);
}
 ...
 */
static inline int
nr_php_psr7_is_uri (zval *z TSRMLS_DC)
{
  return nr_php_object_instanceof_class (z,
    "Psr\\Http\\Message\\UriInterface" TSRMLS_CC);
}
 ...
 */
extern char *
nr_php_psr7_message_get_header (zval *message,
 ...
 */
extern char *
nr_php_psr7_request_uri (zval *request TSRMLS_DC);
