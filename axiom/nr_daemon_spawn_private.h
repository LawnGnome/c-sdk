 ...
 *
 * See: See: http://pubs.opengroup.org/onlinepubs/009695399/functions/exec.html
 */
extern void nr_argv_append (nr_argv_t *argv, const char *flag_or_value);

extern void nr_argv_append_flag (nr_argv_t *argv, const char *flag, const char *fmt, ...);
...
extern nr_argv_t *nr_daemon_args_to_argv (const char *name, const nr_daemon_args_t *args);
