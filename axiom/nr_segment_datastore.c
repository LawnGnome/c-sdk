...
void nr_segment_datastore_end(nr_segment_t* segment,
  ...
  /*
   * We set the end time here because we need the duration. This will not be
   * overwritten in nr_segment_end because it will see it has already been set.
   */
