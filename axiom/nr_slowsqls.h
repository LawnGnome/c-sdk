/*
 * This file contains functions for storage and aggregation of slow SQL statements.
 */
...
typedef struct _nr_slowsqls_params_t {
  ...
  const char *input_query_json;      /* Optional query language (such as DQL) was used to create the SQL */
...
extern void nr_slowsqls_add (nr_slowsqls_t *slowsqls, const nr_slowsqls_params_t *params);
