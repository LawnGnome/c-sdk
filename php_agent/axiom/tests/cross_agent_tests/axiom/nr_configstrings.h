 ...
 *
 * The PHP Engine delivers the given value  false  (without quotes) to us as
 * 0-length string (why?). The PHP Engine delivers the given value "false" (with
 * quotes) to us as the string "false". The PHP Engine delivers the given value
 * true   (without quotes) to us as 1-length string "1". The PHP Engine delivers
 * the given value "true"  (with    quotes) to us as the string "true".
 *
