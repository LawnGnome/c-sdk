...
typedef enum _nrotype_t {
  ...
  NR_OBJECT_DOUBLE      = 6,
  NR_OBJECT_STRING      = 7,
  NR_OBJECT_JSTRING     = 8,    /* Pre-formatted JSON string */
  NR_OBJECT_HASH        = 9,
  NR_OBJECT_ARRAY       = 10,
} nrotype_t;
 ...
 */
extern nr_status_t nro_set_hash       (nrobj_t *obj, const char *key, const nrobj_t *value);
...
extern nr_status_t nro_set_hash_boolean    (nrobj_t *obj, const char *key, int value);
extern nr_status_t nro_set_hash_int        (nrobj_t *obj, const char *key, int value);
extern nr_status_t nro_set_hash_long       (nrobj_t *obj, const char *key, int64_t value);
extern nr_status_t nro_set_hash_double     (nrobj_t *obj, const char *key, double value);
extern nr_status_t nro_set_hash_string     (nrobj_t *obj, const char *key, const char *value);
extern nr_status_t nro_set_hash_jstring    (nrobj_t *obj, const char *key, const char *value);
...
extern nr_status_t nro_set_array_string    (nrobj_t *obj, int idx, const char *value);
extern nr_status_t nro_set_array_jstring   (nrobj_t *obj, int idx, const char *value);
...
extern const nrobj_t *nro_get_hash_value          (const nrobj_t *obj, const char *key, nr_status_t *errp);
extern const nrobj_t *nro_get_hash_value_by_index (const nrobj_t *obj,   int idx, nr_status_t *errp, const char **keyp);
extern const nrobj_t *nro_get_array_value         (const nrobj_t *array, int idx, nr_status_t *errp);

extern int            nro_get_hash_boolean   (const nrobj_t *obj, const char *key, nr_status_t *errp);
extern int            nro_get_hash_int       (const nrobj_t *obj, const char *key, nr_status_t *errp);
extern int64_t        nro_get_hash_long      (const nrobj_t *obj, const char *key, nr_status_t *errp);
extern const char *   nro_get_hash_string    (const nrobj_t *obj, const char *key, nr_status_t *errp);
extern const char *   nro_get_hash_jstring   (const nrobj_t *obj, const char *key, nr_status_t *errp);
extern double         nro_get_hash_double    (const nrobj_t *obj, const char *key, nr_status_t *errp);
extern const nrobj_t *nro_get_hash_hash      (const nrobj_t *obj, const char *key, nr_status_t *errp);
extern const nrobj_t *nro_get_hash_array     (const nrobj_t *obj, const char *key, nr_status_t *errp);

extern int            nro_get_array_boolean  (const nrobj_t *obj, int key, nr_status_t *errp);
extern int            nro_get_array_int      (const nrobj_t *obj, int key, nr_status_t *errp);
extern int64_t        nro_get_array_long     (const nrobj_t *obj, int key, nr_status_t *errp);
extern int            nro_get_array_ival     (const nrobj_t *obj, int key, nr_status_t *errp);
extern const char *   nro_get_array_string   (const nrobj_t *obj, int key, nr_status_t *errp);
extern const char *   nro_get_array_jstring  (const nrobj_t *obj, int key, nr_status_t *errp);
extern double         nro_get_array_double   (const nrobj_t *obj, int key, nr_status_t *errp);
extern const nrobj_t *nro_get_array_hash     (const nrobj_t *obj, int key, nr_status_t *errp);
extern const nrobj_t *nro_get_array_array    (const nrobj_t *obj, int key, nr_status_t *errp);
 ...
 */
typedef nr_status_t (*nrhashiter_t)(const char *key, const nrobj_t *val, void *ptr);
