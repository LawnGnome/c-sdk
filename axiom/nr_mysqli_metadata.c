...
static inline void
nr_mysqli_metadata_add_property (nrobj_t *link,
                                 const char *name,
                                 const char *value)
{
  if (value) {
...
nr_mysqli_metadata_t *
nr_mysqli_metadata_create (void)
{
...
void
nr_mysqli_metadata_destroy (nr_mysqli_metadata_t **metadata_ptr)
{
...
nr_status_t
nr_mysqli_metadata_get (const nr_mysqli_metadata_t *metadata,
...
nr_status_t
nr_mysqli_metadata_set_connect (nr_mysqli_metadata_t *metadata,
                                nr_mysqli_metadata_link_handle_t handle,
                                const char *host,
                                const char *user,
                                const char *password,
...
nr_status_t
nr_mysqli_metadata_set_database (nr_mysqli_metadata_t *metadata,
                                 nr_mysqli_metadata_link_handle_t handle,
                                 const char *database)
{
  nrobj_t *link;
...
nr_status_t
nr_mysqli_metadata_set_option (nr_mysqli_metadata_t *metadata,
                               nr_mysqli_metadata_link_handle_t handle,
                               long option,
                               const char *value)
{
...
nrobj_t *
nr_mysqli_metadata_create_or_get (nr_mysqli_metadata_t *metadata,
                                  nr_mysqli_metadata_link_handle_t handle)
{
  const nrobj_t *found;
  char id[NR_MYSQLI_METADATA_ID_SIZE];
...
void
nr_mysqli_metadata_id (nr_mysqli_metadata_link_handle_t handle,
...
void
nr_mysqli_metadata_save (nr_mysqli_metadata_t *metadata,
                         nr_mysqli_metadata_link_handle_t handle,
                         const nrobj_t *link)
{
  char id[NR_MYSQLI_METADATA_ID_SIZE];
  ...
  if ((NULL == metadata) ||
      (NULL == link) || (NR_OBJECT_HASH != nro_type (link))) {
    return;
  }
