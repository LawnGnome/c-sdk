 ...
 */
#define OP_ARRAY_IS_A_FILE(OP)              ((0 == nr_php_op_array_function_name(OP)) && nr_php_op_array_file_name(OP))
#define OP_ARRAY_IS_FILE(OP, FNAME)         ((OP_ARRAY_IS_A_FILE(OP)) && (nr_strcaseidx (nr_php_op_array_file_name(OP),(FNAME)) >= 0))
#define OP_ARRAY_IS_A_FUNCTION(OP)          (nr_php_op_array_function_name(OP) && (0 == (OP)->scope))
#define OP_ARRAY_IS_FUNCTION(OP, FNAME)     (0 == nr_strcmp (nr_php_op_array_function_name(OP),(FNAME)))
#define OP_ARRAY_IS_A_METHOD(OP)            (nr_php_op_array_function_name(OP) && (OP)->scope)
#define OP_ARRAY_IS_METHOD(OP, FNAME)       (0 == nr_strcmp (nr_php_op_array_function_name(OP),(FNAME)))
...
typedef nr_framework_classification_t (*nr_framework_special_fn_t) (const zend_op_array *op_array TSRMLS_DC);
 ...
 *           which were a part of this request:
 *
 *           Supposing set_appname is called after Drupal is detected, we want
