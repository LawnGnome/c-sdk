...
static void
test_bytes_equal_fn (const char *testname, const uint8_t *expected,
  size_t expected_len, const nr_flatbuffer_t *fb, const char *file, int line)
{
  tlib_pass_if_bytes_equal_f (testname, expected, expected_len,
    nr_flatbuffers_data (fb), nr_flatbuffers_len (fb), file, line);
}

static void
test_byte_layout_numbers (void)
{
  nr_flatbuffer_t *fb;
  ...
  expected = (const uint8_t[]){ 0xCC, 0xCC, 0xCC, 0xFC, 0xEE, 0xFE, 0x22, 0x82, 0x00, 0xFF, 0x81, 0x01 };
  nr_flatbuffers_prepend_i32 (fb, -53687092);
  test_bytes_equal (expected, 12, fb);

  expected = (const uint8_t[]){ 0x32, 0x54, 0x76, 0x98, 0xCC, 0xCC, 0xCC, 0xFC, 0xEE, 0xFE, 0x22, 0x82, 0x00, 0xFF, 0x81, 0x01 };
...
static void
test_vtable_deduplication (void)
{
  nr_flatbuffer_t *fb;
  ...
  /* TODO(msl): verify data can be succesfully read. */

  nr_flatbuffers_table_init (&tbl, nr_flatbuffers_data (fb),
    nr_flatbuffers_len (fb), nr_flatbuffers_len (fb) - obj0);
  tlib_pass_if_size_t_equal (__func__, 12, tbl.vsize);
  tlib_pass_if_uint8_t_equal (__func__, 11, nr_flatbuffers_table_read_u8 (&tbl, 1, 0));
  tlib_pass_if_uint8_t_equal (__func__, 22, nr_flatbuffers_table_read_u8 (&tbl, 2, 0));
  tlib_pass_if_uint8_t_equal (__func__, 33, nr_flatbuffers_table_read_u8 (&tbl, 3, 0));

  nr_flatbuffers_table_init (&tbl, nr_flatbuffers_data (fb),
    nr_flatbuffers_len (fb), nr_flatbuffers_len (fb) - obj1);
  tlib_pass_if_size_t_equal (__func__, 12, tbl.vsize);
  tlib_pass_if_uint8_t_equal (__func__, 44, nr_flatbuffers_table_read_u8 (&tbl, 1, 0));
  tlib_pass_if_uint8_t_equal (__func__, 55, nr_flatbuffers_table_read_u8 (&tbl, 2, 0));
  tlib_pass_if_uint8_t_equal (__func__, 66, nr_flatbuffers_table_read_u8 (&tbl, 3, 0));

  nr_flatbuffers_table_init (&tbl, nr_flatbuffers_data (fb),
    nr_flatbuffers_len (fb), nr_flatbuffers_len (fb) - obj2);
  tlib_pass_if_size_t_equal (__func__, 12, tbl.vsize);
  tlib_pass_if_uint8_t_equal (__func__, 77, nr_flatbuffers_table_read_u8 (&tbl, 1, 0));
  tlib_pass_if_uint8_t_equal (__func__, 88, nr_flatbuffers_table_read_u8 (&tbl, 2, 0));
  tlib_pass_if_uint8_t_equal (__func__, 99, nr_flatbuffers_table_read_u8 (&tbl, 3, 0));

  nr_flatbuffers_destroy (&fb);
}

static void
test_prepend_bytes (void)
{
  int i;
  uint8_t expected[30];
  ...
  tlib_pass_if_bytes_equal (__func__,
    nr_flatbuffers_data (a), nr_flatbuffers_len (a),
    nr_flatbuffers_data (b), nr_flatbuffers_len (b));
...
static void
fuzz_encode_decode (uint64_t seed, int ntables, int nfields)
{
  nr_flatbuffer_t *fb;
  nr_random_t *rng;
  uint32_t *offsets;
  ...
  for (int i = 0; i < ntables; i++) {
    ...
    for (int j = 0; j < nfields; j++) {
      ...
      switch (data_type) {
        case 0:  nr_flatbuffers_object_prepend_bool (fb, j, bool_val, 0); break;
        case 1:  nr_flatbuffers_object_prepend_i8   (fb, j, i8_val,   0); break;
        case 2:  nr_flatbuffers_object_prepend_u8   (fb, j, u8_val,   0); break;
        case 3:  nr_flatbuffers_object_prepend_i16  (fb, j, i16_val,  0); break;
        case 4:  nr_flatbuffers_object_prepend_u16  (fb, j, u16_val,  0); break;
        case 5:  nr_flatbuffers_object_prepend_i32  (fb, j, i32_val,  0); break;
        case 6:  nr_flatbuffers_object_prepend_u32  (fb, j, u32_val,  0); break;
        case 7:  nr_flatbuffers_object_prepend_i64  (fb, j, i64_val,  0); break;
        case 8:  nr_flatbuffers_object_prepend_u64  (fb, j, u64_val,  0); break;
        case 9:  nr_flatbuffers_object_prepend_f32  (fb, j, f32_val,  0); break;
        case 10: nr_flatbuffers_object_prepend_f64  (fb, j, f64_val,  0); break;
      }
    }
  ...
  for (int i = 0; i < ntables; i++) {
    ...
    nr_flatbuffers_table_init (&tbl, nr_flatbuffers_data (fb),
      nr_flatbuffers_len (fb), nr_flatbuffers_len (fb) - offsets[i]);
        ...
        case 0:
          {
            ...
            did_fail = tlib_pass_if_true (__func__, bool_val == actual, "i=%d j=%d expected=%d actual=%d", i, j, bool_val, actual);
          }
          break;
        case 1:
          {
            int8_t actual = nr_flatbuffers_table_read_i8 (&tbl, j, 0);
            did_fail = tlib_pass_if_true (__func__, i8_val == actual, "i=%d j=%d expected=%" PRId8 " actual=%" PRId8, i, j, i8_val, actual);
          }
          break;
        case 2:
          {
            uint8_t actual = nr_flatbuffers_table_read_u8 (&tbl, j, 0);
            did_fail = tlib_pass_if_true (__func__, u8_val == actual, "i=%d j=%d expected=%" PRIu8 " actual=%" PRIu8, i, j, u8_val, actual);
          }
          break;
        case 3:
          {
            int16_t actual = nr_flatbuffers_table_read_i16 (&tbl, j, 0);
            did_fail = tlib_pass_if_true (__func__, i16_val == actual, "i=%d j=%d expected=%" PRId16 " actual=%" PRId16, i, j, i16_val, actual);
          }
          break;
        case 4:
          {
            uint16_t actual = nr_flatbuffers_table_read_u16 (&tbl, j, 0);
            did_fail = tlib_pass_if_true (__func__, u16_val == actual, "i=%d j=%d expected=%" PRIu16 " actual=%" PRIu16, i, j, u16_val, actual);
          }
          break;
        case 5:
          {
            int32_t actual = nr_flatbuffers_table_read_i32 (&tbl, j, 0);
            did_fail = tlib_pass_if_true (__func__, i32_val == actual, "i=%d j=%d expected=%" PRId32 " actual=%" PRId32, i, j, i32_val, actual);
          }
          break;
        case 6:
          {
            uint32_t actual = nr_flatbuffers_table_read_u32 (&tbl, j, 0);
            did_fail = tlib_pass_if_true (__func__, u32_val == actual, "i=%d j=%d expected=%#" PRIx32 " actual=%#" PRIx32, i, j, u32_val, actual);
          }
          break;
        case 7:
          {
            int64_t actual = nr_flatbuffers_table_read_i64 (&tbl, j, 0);
            did_fail = tlib_pass_if_true (__func__, i64_val == actual, "i=%d j=%d expected=%" PRIx64 " actual=%" PRIx64, i, j, i64_val, actual);
          }
          break;
        case 8:
          {
            uint64_t actual = nr_flatbuffers_table_read_u64 (&tbl, j, 0);
            did_fail = tlib_pass_if_true (__func__, u64_val == actual, "i=%d j=%d expected=%" PRIx64 " actual=%" PRIx64, i, j, u64_val, actual);
          }
          break;
        case 9:
          {
            float actual = nr_flatbuffers_table_read_f32 (&tbl, j, 0);
            did_fail = tlib_pass_if_true (__func__, f32_val == actual, "i=%d j=%d expected=%f actual=%f", i, j, f32_val, actual);
          }
          break;
        case 10:
          {
            double actual = nr_flatbuffers_table_read_f64 (&tbl, j, 0);
            did_fail = tlib_pass_if_true (__func__, f64_val == actual, "i=%d j=%d expected=%f actual=%f", i, j, f64_val, actual);
          }
          break;
      }
...
test_read_indirect (void)
{
  ...
  nr_flatbuffers_table_init_root (&tbl, nr_flatbuffers_data (fb), nr_flatbuffers_len (fb));

  pos = nr_flatbuffers_table_read_vector (&tbl, 0);
  tlib_fail_if_uint32_t_equal (__func__, 0, pos.offset);
  tlib_pass_if_uint32_t_equal (__func__, 1, nr_flatbuffers_table_read_vector_len (&tbl, 0));
...
test_read_struct (void)
{
  ...
  nr_flatbuffers_object_prepend_struct (fb, 1, nr_flatbuffers_len (fb), 0); /* T.d */
  ...
  tlib_pass_if_int32_t_equal (__func__, 1, nr_flatbuffers_table_read_i32 (&tbl, 0, 0)); /* T.c */

  pos = nr_flatbuffers_table_lookup (&tbl, 1);
  tlib_pass_if_int32_t_equal (__func__, 2, nr_flatbuffers_read_i32 (tbl.data, pos.offset + 0));
  tlib_pass_if_int32_t_equal (__func__, 3, nr_flatbuffers_read_i32 (tbl.data, pos.offset + 4));

  nr_flatbuffers_destroy (&fb);
}

static void
test_read_union (void)
{
  nr_flatbuffers_table_t tbl;
  nr_flatbuffer_t *fb;
  uint32_t offset;
  ...
  tlib_pass_if_int8_t_equal (__func__, 1, nr_flatbuffers_table_read_i8 (&tbl, 0, 0));
  tlib_pass_if_int_equal (__func__, 1, nr_flatbuffers_table_read_union (&tbl, &tbl, 1));
  tlib_pass_if_int32_t_equal (__func__, 42, nr_flatbuffers_table_read_i32 (&tbl, 0, 0));

  nr_flatbuffers_destroy (&fb);
}

static void
test_read_missing_union (void)
{
  nr_flatbuffers_table_t tbl;
  nr_flatbuffer_t *fb;
  uint32_t offset;
  ...
  tlib_pass_if_int8_t_equal (__func__, 1, nr_flatbuffers_table_read_i8 (&tbl, 0, 0));
  tlib_pass_if_int_equal (__func__, 0, nr_flatbuffers_table_read_union (&tbl, &tbl, 1));
...
test_read_string (void)
{
  ...
  tlib_pass_if_str_equal (__func__, "Hello, World!", nr_flatbuffers_table_read_str (&tbl, 0));

  nr_flatbuffers_destroy (&fb);
}

static void
test_lookup_unknown_field (void)
{
  nr_flatbuffers_table_t tbl;
  nr_flatbuffer_t *fb;
  ...
  tlib_pass_if_int32_t_equal (__func__, 0, nr_flatbuffers_table_read_i32 (&tbl, 1, 0));

  nr_flatbuffers_destroy (&fb);
}

static void
test_minimum_flatbuffer_size (void)
{
  nr_flatbuffer_t *fb;
  size_t min_len;
  ...
  tlib_pass_if_size_t_equal ("expected minimum flatbuffer size", MIN_FLATBUFFER_SIZE, min_len);
...
test_main (void *p NRUNUSED)
{
   ...
   *
   * TODO(msl): Use a random seed?
   * TODO(msl): Make this controllable via env vars?
   */
  fuzz_seed = 48271;
