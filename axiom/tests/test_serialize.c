...
test_get_class_name (void)
{
   ...
   */
  tlib_pass_if_null ("string", nr_serialize_get_class_name (NR_PSTR ("s:3:\"foo\";")));
   ...
   */
  tlib_pass_if_null ("missing length", nr_serialize_get_class_name (NR_PSTR ("O::\"Foo\\Bar\":")));
  tlib_pass_if_null ("missing colon", nr_serialize_get_class_name (NR_PSTR ("O:7:\"Foo\\Bar\"")));
