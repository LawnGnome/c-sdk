 ...
 */
extern void nr_php_pgsql_save_datastore_instance (const zval *pgsql_conn, const char *conn_info TSRMLS_DC);
 ...
 */
extern nr_datastore_instance_t *nr_php_pgsql_retrieve_datastore_instance (const zval *pgsql_conn TSRMLS_DC);
 ...
 * Params  : 1. The pgsql connection resource
 */
extern void nr_php_pgsql_remove_datastore_instance (const zval *pgsql_conn TSRMLS_DC);
