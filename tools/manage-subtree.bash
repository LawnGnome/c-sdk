...
then
    ...
    echo "CALLING: "
    echo ""   
    echo "       $ ./manage-subtree.bash view_commit_hashes"     
    echo "       $ ./manage-subtree.bash set_commit_hashes"         
    echo ""           
    echo "       $ ./manage-subtree.bash add_subtrees"
    echo "       $ ./manage-subtree.bash update_subtrees"    
    echo ""       
    echo "       $ ./manage-subtree.bash update_version_yml"                 
fi