...
/* This is defined only to satisfy link requirements, and is not shared amongst threads. */
nrapplist_t *nr_agent_applist = 0;

void
nr_agent_close_daemon_connection (void)
{
}

nr_status_t
nr_agent_lock_daemon_mutex (void)
{
  return NR_SUCCESS;
}

nr_status_t
nr_agent_unlock_daemon_mutex (void)
{
  return NR_SUCCESS;
}
...
test_encode_errors (void)
{
  ...
  txn.error = nr_error_create (123, "msg", "cls", "[\"stacktrace json\"]", 887788 * NR_TIME_DIVISOR_MS);
  ...
  data_type = nr_flatbuffers_table_read_i8 (&tbl, MESSAGE_FIELD_DATA_TYPE, MESSAGE_BODY_NONE);
  did_pass = tlib_pass_if_true (__func__, MESSAGE_BODY_TXN == data_type, "data_type=%d", data_type);
  if (0 != did_pass) {
    goto done;
  }
  ...
  tlib_pass_if_int32_t_equal (__func__, 123,
   ...
   * arguments to match.
   */
  tlib_pass_if_bytes_equal_f (__func__,
    NR_PSTR ("[887788,\"txnname\",\"msg\",\"cls\",{\"stack_trace\":[\"stacktrace json\"],\"agentAttributes\":{\"agent_long\":2},\"userAttributes\":{\"user_long\":1},\"intrinsics\":{\"a\":\"b\"}}]"),
    nr_flatbuffers_table_read_bytes (&tbl, ERROR_FIELD_DATA),
    nr_flatbuffers_table_read_vector_len (&tbl, ERROR_FIELD_DATA),
    __FILE__, __LINE__);
...
test_encode_slowsqls (void)
{
  ...
  count = nr_flatbuffers_table_read_vector_len (&tbl, TRANSACTION_FIELD_SLOW_SQLS);
  if (0 != tlib_pass_if_true (__func__, 1 == count, "count=%d", count)) {
    goto done;
  }

  slowsqls = nr_flatbuffers_table_read_vector (&tbl, TRANSACTION_FIELD_SLOW_SQLS);

  nr_flatbuffers_table_init (&slow, tbl.data, tbl.length,
    nr_flatbuffers_read_indirect (tbl.data, slowsqls).offset);

  tlib_pass_if_int32_t_equal (__func__, 1787882637,
...
test_encode_metrics (void)
{
  ...
  nrm_add_apdex (txn.unscoped_metrics, "apdex", 1, 2, 3, 4.816326 * NR_TIME_DIVISOR);
  ...
  tlib_pass_if_str_equal (__func__, "scoped",
    nr_flatbuffers_table_read_str (&tbl, METRIC_FIELD_NAME));

  data = nr_flatbuffers_table_lookup (&tbl, METRIC_FIELD_DATA);
  tlib_pass_if_double_equal (__func__, 1,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_COUNT));
  tlib_pass_if_double_equal (__func__, 1,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_TOTAL));
  tlib_pass_if_double_equal (__func__, 1,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_EXCLUSIVE));
  tlib_pass_if_double_equal (__func__, 1,
  ...
  tlib_pass_if_int8_t_equal (__func__, 1,
    nr_flatbuffers_read_i8 (tbl.data, data.offset + METRIC_DATA_VOFFSET_SCOPED));
  tlib_pass_if_int8_t_equal (__func__, 0,
    nr_flatbuffers_read_i8 (tbl.data, data.offset + METRIC_DATA_VOFFSET_FORCED));
  ...
  tlib_pass_if_str_equal (__func__, "apdex",
    nr_flatbuffers_table_read_str (&tbl, METRIC_FIELD_NAME));

  data = nr_flatbuffers_table_lookup (&tbl, METRIC_FIELD_DATA);
  tlib_pass_if_double_equal (__func__, 1.0,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_COUNT));
  tlib_pass_if_double_equal (__func__, 2.0,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_TOTAL));
  tlib_pass_if_double_equal (__func__, 3.0,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_EXCLUSIVE));
  tlib_pass_if_double_equal (__func__, 4.816326,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_MIN));
  tlib_pass_if_double_equal (__func__, 4.816326,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_MAX));
  tlib_pass_if_double_equal (__func__, 0.0,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_SOS));
  tlib_pass_if_int8_t_equal (__func__, 0,
    nr_flatbuffers_read_i8 (tbl.data, data.offset + METRIC_DATA_VOFFSET_SCOPED));
  tlib_pass_if_int8_t_equal (__func__, 0,
  ...
  tlib_pass_if_str_equal (__func__, "forced",
    nr_flatbuffers_table_read_str (&tbl, METRIC_FIELD_NAME));

  data = nr_flatbuffers_table_lookup (&tbl, METRIC_FIELD_DATA);
  tlib_pass_if_double_equal (__func__, 1.0,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_COUNT));
  tlib_pass_if_double_equal (__func__, 2.222222,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_TOTAL));
  tlib_pass_if_double_equal (__func__, 3.456789,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_EXCLUSIVE));
  tlib_pass_if_double_equal (__func__, 4.482911,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_MIN));
  tlib_pass_if_double_equal (__func__, 5.555556,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_MAX));
  tlib_pass_if_double_equal (__func__, 6.060606,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_SOS));
  tlib_pass_if_int8_t_equal (__func__, 0,
    nr_flatbuffers_read_i8 (tbl.data, data.offset + METRIC_DATA_VOFFSET_SCOPED));
  tlib_pass_if_int8_t_equal (__func__, 1,
  ...
  tlib_pass_if_str_equal (__func__, "unscoped",
    nr_flatbuffers_table_read_str (&tbl, METRIC_FIELD_NAME));
  ...
  tlib_pass_if_double_equal (__func__, 2.0,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_MAX));
  tlib_pass_if_double_equal (__func__, 4.0,
    nr_flatbuffers_read_f64 (tbl.data, data.offset + METRIC_DATA_VOFFSET_SOS));
  tlib_pass_if_int8_t_equal (__func__, 0,
    nr_flatbuffers_read_i8 (tbl.data, data.offset + METRIC_DATA_VOFFSET_SCOPED));
  tlib_pass_if_int8_t_equal (__func__, 0,
...
test_encode_error_events (void)
{
  ...
  nr_memset (&txn, 0, sizeof (txn));
  txn.error = nr_error_create (123, "msg", "cls", "[\"stacktrace json\"]", 857281 * NR_TIME_DIVISOR_MS);
  ...
  count = nr_flatbuffers_table_read_vector_len (&tbl, TRANSACTION_FIELD_ERROR_EVENTS);
  if (0 != tlib_pass_if_true (__func__, 1 == count, "count=%d", count)) {
    goto done;
  }

  events = nr_flatbuffers_table_read_vector (&tbl, TRANSACTION_FIELD_ERROR_EVENTS);
  ...
  tlib_pass_if_bytes_equal_f (__func__,
    ...
    nr_flatbuffers_table_read_vector_len (&tbl, EVENT_FIELD_DATA),
    __FILE__, __LINE__);
...
static void
test_encode_custom_events (void)
{
  nrtxn_t txn;
  nr_flatbuffers_table_t tbl;
  nrobj_t *params;
  ...
  count = nr_flatbuffers_table_read_vector_len (&tbl, TRANSACTION_FIELD_CUSTOM_EVENTS);
  if (0 != tlib_pass_if_true (__func__, 2 == count, "count=%d", count)) {
    goto done;
  }

  events = nr_flatbuffers_table_read_vector (&tbl, TRANSACTION_FIELD_CUSTOM_EVENTS);

  nr_flatbuffers_table_init (&tbl, tbl.data, tbl.length,
    nr_flatbuffers_read_indirect (tbl.data, events).offset);
  tlib_pass_if_bytes_equal_f (__func__,
    NR_PSTR ("[{\"type\":\"type1\",\"timestamp\":123.00000},{\"b\":\"c\",\"a\":1},{}]"),
    nr_flatbuffers_table_read_bytes (&tbl, EVENT_FIELD_DATA),
    nr_flatbuffers_table_read_vector_len (&tbl, EVENT_FIELD_DATA),
    __FILE__, __LINE__);
  ...
  nr_flatbuffers_table_init (&tbl, tbl.data, tbl.length,
    nr_flatbuffers_read_indirect (tbl.data, events).offset);
  tlib_pass_if_bytes_equal_f (__func__,
    NR_PSTR ("[{\"type\":\"type2\",\"timestamp\":123.00000},{\"b\":\"c\",\"a\":1},{}]"),
    nr_flatbuffers_table_read_bytes (&tbl, EVENT_FIELD_DATA),
    nr_flatbuffers_table_read_vector_len (&tbl, EVENT_FIELD_DATA),
    __FILE__, __LINE__);
...
test_encode_trace (void)
{
  ...
  txn.attributes = nr_attributes_create (0);
  nro_set_hash_string (txn.intrinsics, "a", "b");
  nr_attributes_user_add_long (txn.attributes, NR_ATTRIBUTE_DESTINATION_TXN_TRACE, "user_long", 1);
  nr_attributes_agent_add_long (txn.attributes, NR_ATTRIBUTE_DESTINATION_TXN_TRACE, "agent_long", 2);
  nr_attributes_user_add_long (txn.attributes, NR_ATTRIBUTE_DESTINATION_ALL &~ NR_ATTRIBUTE_DESTINATION_TXN_TRACE, "NOPE", 1);
  nr_attributes_agent_add_long (txn.attributes, NR_ATTRIBUTE_DESTINATION_ALL &~ NR_ATTRIBUTE_DESTINATION_TXN_TRACE, "NOPE", 2);
  ...
  tlib_pass_if_double_equal (__func__, 1000.0,
    nr_flatbuffers_table_read_f64 (&tbl, TRACE_FIELD_TIMESTAMP, 0.0));
  tlib_pass_if_double_equal (__func__, 1234000.0,
  ...
  tlib_pass_if_bytes_equal_f (__func__,
    NR_PSTR (
      "[[0,{},{},[0,1234000,\"ROOT\",{},[[0,1234000,\"`0\",{},[[1000,2000,\"`1\",{},[]]]]]],"
      "{\"agentAttributes\":{\"agent_long\":2},\"userAttributes\":{\"user_long\":1},\"intrinsics\":{\"a\":\"b\"}}],"
      "[\"the_root\",\"the_node\"]]"),
    nr_flatbuffers_table_read_bytes (&tbl, TRACE_FIELD_DATA),
    nr_flatbuffers_table_read_vector_len (&tbl, TRACE_FIELD_DATA),
    __FILE__, __LINE__);
...
test_encode_txn_event (void)
{
  ...
  did_pass = tlib_pass_if_true (__func__,
    0 != nr_flatbuffers_table_read_union (&tbl, &tbl, TRANSACTION_FIELD_TXN_EVENT),
    "trace missing");
  if (0 != did_pass) {
    goto done;
  }
  ...
  tlib_pass_if_bytes_equal_f (__func__,
    NR_PSTR (
      "[{\"type\":\"Transaction\",\"name\":\"my_txn_name\",\"timestamp\":123.00000,"
        "\"duration\":0.98700,\"totalTime\":0.98700,\"nr.apdexPerfZone\":\"F\","
        "\"queueDuration\":3.00000,\"externalDuration\":2.00000,\"databaseDuration\":1.00000},"
...
test_empty_txn (void)
{
  ...
  nr_flatbuffers_table_init_root (&tbl,
    (const uint8_t *)nr_buffer_cptr (buf), nr_buffer_len (buf));

  tlib_pass_if_int_equal (__func__, MESSAGE_BODY_TXN,
    nr_flatbuffers_table_read_i8 (&tbl, MESSAGE_FIELD_DATA_TYPE, MESSAGE_BODY_NONE));
   ...
   */
  absolute = nr_flatbuffers_table_lookup (&tbl, TRANSACTION_FIELD_SYNTHETICS_RESOURCE_ID);
   ...
   */
  tlib_pass_if_null (__func__, nr_flatbuffers_table_read_bytes (&tbl, TRANSACTION_FIELD_NAME));

  tlib_pass_if_int_equal (__func__, nr_getpid (), (int)nr_flatbuffers_table_read_i32 (&tbl, TRANSACTION_FIELD_PID, 0));
