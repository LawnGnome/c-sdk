...
extern int nr_traces_json_print_segments (nrbuf_t *buf, const nrtxn_t *txn, const nrtxnnode_t *node, int next, const nr_harvest_trace_node_t *nodes, nrpool_t *node_names);
 ...
 */
extern nr_harvest_trace_node_t *
