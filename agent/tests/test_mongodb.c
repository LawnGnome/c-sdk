...
static void
test_host_and_port_path_or_id (const char *input, const char *expected_host,
  const char *expected_port_path_or_id TSRMLS_DC)
{
  ...
  nr_mongodb_get_host_and_port_path_or_id (obj, &host, &port_path_or_id TSRMLS_CC);

  tlib_pass_if_str_equal ("correct host", expected_host, host);
  tlib_pass_if_str_equal ("correct port", expected_port_path_or_id, port_path_or_id);
...
static void
test_get_host_and_port_path_or_id (TSRMLS_D)
{
  zval *obj;
  char *host = NULL;
  char *port_path_or_id = NULL;
   ...
   * Test : Bad input.
   */
  nr_mongodb_get_host_and_port_path_or_id (NULL, &host, &port_path_or_id TSRMLS_CC);
   ...
   * sockets are used.
   */
  test_host_and_port_path_or_id ("'localhost', 27017", system_host_name, "27017" TSRMLS_CC);
  test_host_and_port_path_or_id ("'my_db', 4321", "my_db", "4321" TSRMLS_CC);
  test_host_and_port_path_or_id ("'/tmp/mongodb-27017.sock', 27017", system_host_name, "/tmp/mongodb-27017.sock" TSRMLS_CC);
...
static void
test_host_and_port_path_or_id_individually (const char *input, const char *expected_host, const char *expected_port_path_or_id TSRMLS_DC)
{
  char *host;
  char *port;
  char *params = nr_formatf ("new \\MongoDB\\Driver\\Server(%s)", input);
...
static void
test_get_host_and_port_path_or_id_individually (TSRMLS_D)
{
  zval *obj;
  char *host = NULL;
  char *port_path_or_id = NULL;
  ...
  test_host_and_port_path_or_id_individually ("null, null", "unknown", "unknown" TSRMLS_CC);
  test_host_and_port_path_or_id_individually ("'', ''",     "unknown", "unknown" TSRMLS_CC);
  test_host_and_port_path_or_id_individually ("7, 'foo'",   "unknown", "unknown" TSRMLS_CC);
  test_host_and_port_path_or_id_individually ("0.31, 0.45", "unknown", "unknown" TSRMLS_CC);

  /*
   * Test: Normal operation.
   */
  test_host_and_port_path_or_id_individually ("'localhost', 27017", system_host_name, "27017" TSRMLS_CC);
  test_host_and_port_path_or_id_individually ("'127.0.0.1', 3311", system_host_name, "3311" TSRMLS_CC);
  test_host_and_port_path_or_id_individually ("'my_db', 27017", "my_db", "27017" TSRMLS_CC);
   ...
   */
  test_host_and_port_path_or_id_individually ("'/tmp/mongodb-27017.sock', 27017", "/tmp/mongodb-27017.sock", "27017" TSRMLS_CC);
  test_host_and_port_path_or_id_individually ("'/', 4444", "/", "4444" TSRMLS_CC);
