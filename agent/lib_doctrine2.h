 ...
 *           it.
 *
 * Returns : A newly allocated nr_slowsqls_labelled_query_t if successful, NULL otherwise.
 *           It is the caller's responsibility to call nr_free.
 */
extern nr_slowsqls_labelled_query_t *
