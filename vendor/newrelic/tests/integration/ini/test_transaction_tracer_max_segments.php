...
the agent limits the number of custom segments created to that value.
*/

/*INI
newrelic.transaction_tracer.max_segments=256
...
[
  ...
  "?? timeframe stop",
  [
    [{"name":"Custom/my_function"},                     [256, "??", "??", "??", "??", "??"]],
    [{"name":"Custom/my_function",
     "scope":"OtherTransaction/php__FILE__" },          [256, "??", "??", "??", "??", "??"]],
