...
test_strxcpy (void)
{
  ...
  tlib_pass_if_true ("nr_strxcpy from NULL returns dest", (0 != rp) && (rp == dest), "rp=%p dest=%p", rp, dest);

  dest[0] = 'x';
  rp = nr_strxcpy (dest, "abc", 0);
  tlib_pass_if_true ("nr_strxcpy of 0 bytes returns dest", (0 != rp) && (rp == dest) && (0 == dest[0]),
    "rp=%p dest=%p dest[0]=%d", rp, dest, dest[0]);

  filldest (dest, sizeof (dest));
  rp = nr_strxcpy (dest, "abcdef", 3);
  tlib_pass_if_true ("simple nr_strxcpy", (0 != rp) && (0 == dest[3]) && (3 == nr_strlen (dest)) && (0 == nr_strcmp (dest, "abc")),
    "rp=%p dest[3]=%d dest='%s'", rp, dest[3], dest);
  tlib_pass_if_true ("return pointer is correct", rp == &dest[3], "rp=%p &dest[3]=%p", rp, &dest[3]);
  tlib_pass_if_true ("copy did not overwrite", 5 == dest[4], "dest[4]=%d", dest[4]);
}
...
test_strlcpy (void)
{
  ...
  tlib_pass_if_true ("nr_strlcpy from NULL returns dest", (0 != rp) && (rp == dest), "rp=%p dest=%p", rp, dest);

  rp = nr_strlcpy (dest, "abc", 0);
  tlib_pass_if_true ("nr_strlcpy with 0 length returns NULL", 0 == rp, "rp=%p", rp);
  ...
  tlib_pass_if_true ("simple nr_strlcpy", (0 != rp) && (0 == dest[3]) && (3 == nr_strlen (dest)) && (0 == nr_strcmp (dest, "abc")),
    "rp=%p dest[3]=%d dest='%s'", rp, dest[3], dest);
  tlib_pass_if_true ("return pointer is correct", rp == &dest[3], "rp=%p &dest[3]=%p", rp, &dest[3]);
  tlib_pass_if_true ("copy did not overwrite", 5 == dest[4], "dest[4]=%d", dest[4]);
  ...
  tlib_pass_if_true ("nr_strlcpy of empty string works", (0 != rp) && (rp == dest) && (0 == dest[0]) && (2 == dest[1]),
  ...
  tlib_pass_if_true ("nr_strlcpy of string that is too long", (0 != rp) && (rp == &dest[7]) && (0 == dest[7]) && (9 == dest[8]) &&
    (0 == nr_strcmp (dest, "abcdefg")), "rp=%p &dest[7]=%p dest[7]=%d dest[0]=%d dest='%s'", rp, &dest[7], dest[7], dest[8], dest);
  ...
  tlib_pass_if_true ("nr_strlcpy of string exactly length of test", (0 != rp) && (rp == &dest[7]) && (0 == dest[7]) && (9 == dest[8]) &&
    (0 == nr_strcmp (dest, "abcdefg")),
    "rp=%p &dest[7]=%p dest[7]=%d dest[8]=%d dest='%s'", rp, &dest[7], dest[7], dest[8], dest);
  filldest (dest, sizeof (dest));
  rp = nr_strlcpy (dest, "abcdefg", 8);
  tlib_pass_if_true ("nr_strlcpy of string exactly length of test - 1", (0 != rp) && (rp == &dest[7]) && (0 == dest[7]) && (9 == dest[8]) &&
    (0 == nr_strcmp (dest, "abcdefg")),
    "rp=%p &dest[7]=%p dest[7]=%d dest[8]=%d dest='%s'", rp, &dest[7], dest[7], dest[8], dest);
}
...
test_strcpy (void)
{
  ...
  tlib_pass_if_true ("simple nr_strcpy works", 0 != rp && (0 == nr_strcmp (dest, "abcd")), "rp=%p dest='%s'", rp ,dest);

  rp = nr_strcpy (dest, NULL);
  tlib_pass_if_true ("nr_strcpy of NULL returns empty string", (0 != rp) && (rp == dest) && (0 == dest[0]), "rp=%p rp[0]=%d", rp, rp[0]);

  nr_strcpy (dest, "abc");
  rp = nr_strcpy (dest, "");
  tlib_pass_if_true ("nr_strcpy of empty returns empty string", (0 != rp) && (rp == dest) && (0 == dest[0]), "rp=%p rp[0]=%d", rp, rp[0]);
}
...
test_strcat (void)
{
  ...
  nr_strcpy (dest, "abc");
  rp = nr_strcat (dest, 0);
  tlib_pass_if_true ("nr_strcat of NULL returns dest", (0 != rp) && (rp == &dest[3]), "rp=%p &dest[3]=%p", rp, &dest[3]);

  rp = nr_strcat (0, "abc");
  tlib_pass_if_true ("srtcat to NULL returns NULL", 0 == rp, "rp=%p", rp);

  rp = nr_strcat (dest, "");
  tlib_pass_if_true ("nr_strcat of empty string works", (0 != rp) && (rp == &dest[3]), "rp=%p &dest[3]=%p", rp, &dest[3]);

  rp = nr_strcat (dest, "def");
  tlib_pass_if_true ("nr_strcat works", (0 != rp) && (rp == &dest[6]) && (0 == nr_strcmp (dest, "abcdef")) && (0 == *rp),
    "rp=%p &dest[6]=%p *rp=%d dest='%s'", rp, &dest[6], *rp, dest);
}
...
test_strnlen (void)
{
  ...
  tlib_pass_if_true ("nr_strnlen with 0 length returns 0", 0 == rv, "rv=%zu", rv);
  nr_strcpy (dest, "abcdefghij");

  rv = nr_strnlen (dest, 8);
  tlib_pass_if_true ("nr_strnlen with overlong string returns max", 8 == rv, "rv=%zu", rv);

  nr_strcpy (dest, "abcdefgh");
  rv = nr_strnlen (dest, 8);
  tlib_pass_if_true ("nr_strnlen with longest possible string works", 8 == rv, "rv=%zu", rv);
}
...
test_strnicmp (void)
{
  ...
  rv = nr_strnicmp ("", "", 1);
  tlib_pass_if_true ("nr_strnicmp empty strings returns 0", 0 == rv, "rv=%d", rv);
...
test_strchr (void)
{
  ...
  nr_strcpy (dest, "abc");
  rp = nr_strchr (dest, 0);
  tlib_pass_if_true ("nr_strchr (str, 0) returns EOS", dest+3 == rp, "rp=%p", rp);

  rp = nr_strchr (dest, 'd');
  tlib_pass_if_true ("nr_strchr (str, bad) returns 0", 0 == rp, "rp=%p", rp);

  rp = nr_strchr (dest, 'b');
  tlib_pass_if_true ("nr_strchr (str, good) return OK", dest+1 == rp, "rp=%p", rp);
}
...
test_strrchr (void)
{
  ...
  tlib_pass_if_true ("nr_strrchr (str, 0) returns EOS", dest+3 == rp, "rp=%p", rp);

  rp = nr_strrchr (dest, 'd');
  tlib_pass_if_true ("nr_strrchr (str, bad) returns 0", 0 == rp, "rp=%p", rp);

  rp = nr_strrchr (dest, 'b');
  tlib_pass_if_true ("nr_strrchr (str, good) return OK", dest+1 == rp, "rp=%p", rp);
}
...
test_strnspn (void)
{
  ...
  tlib_pass_if_true ("nr_strnspn (same, same) returns EOS", 6 == rv, "rv=%d", rv);

  rv = nr_strnspn ("abcdef", 6, "ghij", 4);
  tlib_pass_if_true ("nr_strnspn (str, missing) returns 0", 0 == rv, "rv=%d", rv);
...
test_strncaseidx (void)
{
  ...
  for (i = 0; nr_strncaseidx_test_cases[i].testname; i++) {
    ...
    rv = nr_strncaseidx (tc->input_string, tc->input_needle, tc->input_string_len);
    tlib_pass_if_true (tc->testname, rv == tc->expected, "rv=%d tc->expected=%d", rv, tc->expected);
  }
...
static void
test_nr_strncaseidx_last_match (void)
{
  int rv;
  int i;
  ...
  for (i = 0; nr_strncaseidx_test_cases[i].testname; i++) {
    ...
    rv = nr_strncaseidx_last_match (tc->input_string, tc->input_needle, tc->input_string_len);
    tlib_pass_if_true (tc->testname, rv == tc->expected, "rv=%d tc->expected=%d", rv, tc->expected);
  }
...
struct nr_strsplit_testcase {
  ...
  {.input = "",                       .delim = "",   .expected = "[\"\"]",                                .use_empty = 0},
  {.input = "abc",                    .delim = ";",  .expected = "[\"abc\"]",                             .use_empty = 0},
  {.input = "a,b,c",                  .delim = ",",  .expected = "[\"a\",\"b\",\"c\"]",                   .use_empty = 0},
  {.input = "abc;def",                .delim = ";",  .expected = "[\"abc\",\"def\"]",                     .use_empty = 0},
  {.input = "abc   ;def \t ",         .delim = ";",  .expected = "[\"abc\",\"def\"]",                     .use_empty = 0},
  {.input = "  abc \t ; \t  def  \t", .delim = ";",  .expected = "[\"abc\",\"def\"]",                     .use_empty = 0},
  {.input = "abc \t  ",               .delim = ";",  .expected = "[\"abc\"]",                             .use_empty = 0},
  {.input = " \t\t  abc",             .delim = ";",  .expected = "[\"abc\"]",                             .use_empty = 0},
  {.input = " \t\t  abc\t  \t",       .delim = ";",  .expected = "[\"abc\"]",                             .use_empty = 0},
  {.input = "a1,b2;c3",               .delim = ",;", .expected = "[\"a1\",\"b2\",\"c3\"]",                .use_empty = 0},
  {.input = "a1,,b2,c3",              .delim = ",",  .expected = "[\"a1\",\"b2\",\"c3\"]",                .use_empty = 0},
  {.input = "a1,,b2,c3",              .delim = ",",  .expected = "[\"a1\",\"\",\"b2\",\"c3\"]",           .use_empty = 1},
  {.input = ",a1,,b2,c3",             .delim = ",",  .expected = "[\"a1\",\"b2\",\"c3\"]",                .use_empty = 0},
  {.input = ",a1,,b2,c3",             .delim = ",",  .expected = "[\"\",\"a1\",\"\",\"b2\",\"c3\"]",      .use_empty = 1},
  {.input = ",a1,,b2,c3,",            .delim = ",",  .expected = "[\"a1\",\"b2\",\"c3\"]",                .use_empty = 0},
  {.input = ",a1,,b2,c3,",            .delim = ",",  .expected = "[\"\",\"a1\",\"\",\"b2\",\"c3\",\"\"]", .use_empty = 1},
  {.input = ",;;,",                   .delim = ",;", .expected = "[]",                                    .use_empty = 0},
  {.input = ",;;,",                   .delim = ",;", .expected = "[\"\",\"\",\"\",\"\",\"\"]",            .use_empty = 1},
};
...
test_strsplit (void)
{
  ...
  for (i = 0; i < count; i++) {
    ...
    arr = nr_strsplit (testcases[i].input, testcases[i].delim, testcases[i].use_empty);
