...
extern void nr_header_outbound_response_decoded (nrtxn_t *txn, const char *decoded_response,
...
extern nr_status_t nr_header_validate_encoded_string (const char *encoded_string);
extern nr_status_t nr_header_validate_decoded_id (const nrtxn_t *txn, const char *decoded_id);

extern char *nr_header_inbound_response_internal (nrtxn_t *txn, int content_length);
