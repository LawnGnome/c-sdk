 ...
 */
void
nr_fw_micromvc_enable (TSRMLS_D)
{
  NR_UNUSED_TSRMLS;
}
 ...
 */
void
nr_fw_sellvana_enable (TSRMLS_D)
{
  NR_UNUSED_TSRMLS;
}
 ...
 */
void
nr_fw_expression_engine_enable (TSRMLS_D)
{
  NR_UNUSED_TSRMLS;
}
 ...
 */
void
nr_fw_dokuwiki_enable (TSRMLS_D)
{
  NR_UNUSED_TSRMLS;
}
 ...
 */
void
nr_fw_silverstripe_enable (TSRMLS_D)
{
  NR_UNUSED_TSRMLS;
}
 ...
 */
void
nr_fw_sugarcrm_enable (TSRMLS_D)
{
  NR_UNUSED_TSRMLS;
}
