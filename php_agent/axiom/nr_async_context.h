 ...
 */
extern nr_async_context_t* nr_async_context_create(nrtime_t start);
 ...
 */
extern void nr_async_context_destroy(nr_async_context_t** context_ptr);
 ...
 */
extern void nr_async_context_add(nr_async_context_t* context,
                                 nrtime_t duration);
 ...
 *           2. The end time.
 */
extern void nr_async_context_end(nr_async_context_t* context, nrtime_t stop);
 ...
 */
extern nrtime_t nr_async_context_get_duration(
    const nr_async_context_t* context);
