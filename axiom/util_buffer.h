 ...
 *
 * Params  : 1. The return value from nr_buffer_create().
 *
 ...
 *           must call or nr_buffer_cptr() after calling this
 *           function in order to get a valid pointer to the start of the data.
 */
 ...
 *
 * Params  : 1. Pointer to the return value from nr_buffer_create().
 */
