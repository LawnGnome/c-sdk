...
// wire in a JSON blob, it is possible that they may not be well-formed.
...
// Adhere to the spec in agent-spec that:
// The report_period_in_seconds property MUST NOT be set below 5 seconds, or above 300 seconds (5 minutes).
//   If the property is not set, is not a number, or set to 0 or below, then use the default of 60 seconds.
...
// See: https://source.datanerd.us/agents/agent-specs/blob/master/Connect-LEGACY.md
