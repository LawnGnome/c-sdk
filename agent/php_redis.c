...
nr_php_redis_create_datastore_instance (const char *host_or_socket,
                                        zend_long port)
{
...
nr_datastore_instance_t *
nr_php_redis_save_datastore_instance (const zval *redis_conn,
...
nr_datastore_instance_t *
nr_php_redis_retrieve_datastore_instance (const zval *redis_conn TSRMLS_DC)
{
  nr_datastore_instance_t *instance;
  char *key;
...
void
nr_php_redis_remove_datastore_instance (const zval *redis_conn TSRMLS_DC)
{
  char *key;
