 ...
 *
 * Note    : The string must be NUL-terminated, even if a length is provided.
...
extern int nr_string_add_with_hash (nrpool_t *pool, const char *string, uint32_t hash);
extern int nr_string_add_with_hash_length (nrpool_t *pool, const char *string, uint32_t hash, int length);
...
extern int nr_string_find_with_hash (const nrpool_t *pool, const char *string, uint32_t hash);
extern int nr_string_find_with_hash_length (const nrpool_t *pool, const char *string, uint32_t hash, int length);
...
typedef void (*nr_string_pool_apply_func_t) (const char *str, int len,
                                             void *user_data);
