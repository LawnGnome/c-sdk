...
/*
 * Purpose : Check a filename against the defined patterns for transaction file naming.
 *
 ...
 *           2. A regexp (generally from newrelic.ini). See nr_file_namer_match
 *              for information on matching.
 *
 * Returns : the list.
 */
